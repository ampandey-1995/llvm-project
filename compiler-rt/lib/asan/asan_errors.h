...
// Derives from ErrorGeneric to reuse its shadow-byte classification; the
// inherited pc/bp/sp describe a host frame and stay zero here.
struct ErrorNonSelfGeneric : ErrorGeneric {
...
struct ErrorNonSelfAMDGPU : ErrorGeneric {
  CodeObjectLocation cb_loc;
